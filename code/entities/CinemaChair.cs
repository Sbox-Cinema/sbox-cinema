...
public partial class CinemaChair : AnimatedEntity, ICinemaUse
{
    ...
    public void CupholdEntity(ArmrestSide side, Entity entity)
    {
        ...
        {
            boneName = "cupholder_l";
            LeftCuphold = entity;
        }
        else
        {
            boneName = "cupholder_r";
            RightCuphold = entity;
        }
        entity.SetParent(this, boneName);
    }

    public void ToggleArmrest(ArmrestSide side)
    {
        ...
        var currentValue = GetAnimParameterBool(paramName);
        SetAnimParameter(paramName, !currentValue);
    }
