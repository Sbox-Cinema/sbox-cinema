...
public partial class Popcorn : WeaponBase
{
    ...
    public override Model WorldModel => Model.Load("models/popcorn_tub/popcorn_tub_01.vmdl");
    public override string ViewModelPath => "models/popcorn_tub/popcorn_tub_01.vmdl";
