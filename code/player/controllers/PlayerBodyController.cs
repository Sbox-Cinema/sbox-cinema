...
public partial class PlayerBodyController : PlayerController, ISingletonComponent
{
    ...
    public IEnumerable<PlayerBodyControllerMechanic> Mechanics =>
        Entity.Components.GetAll<PlayerBodyControllerMechanic>();

    public PlayerBodyControllerMechanic BestMechanic =>
    ...
    public T GetMechanic<T>() where T : PlayerBodyControllerMechanic
    {
    ...
    public bool IsMechanicActive<T>() where T : PlayerBodyControllerMechanic
    {
    ...
    public override void Simulate(IClient cl)
    {
        ...
        if (Debug)
        {
            ...
            DebugOverlay.ScreenText($"       MoveInput: {Player.MoveInput}", ++lineOffset);
