...
//    protected async Task PlayCurrentMediaOnProjector()
//    {
//        if (CurrentMedia != null)
//        {
//            return;
//        }
//        var player = await CurrentMedia.GetPlayer();
//        Projector.SetMedia(player);
//    }
...
//    [ConCmd.Server]
//    public static void GiveMediaLike(int projectorId, bool like)
//    {
//        var projector = Sandbox.Entity.FindByIndex(projectorId);
//        var controller = projector?.Components.Get<MediaController>();
